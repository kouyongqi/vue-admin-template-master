...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      {
        path: 'edit/:id', //:id 类似 sql语句的？占位符，传进来请求路径id
        name: '讲师修改',
        component: () => import('@/views/edu/teacher/add'),
    ...
    children: [
      {
        path: 'create',
        name: '数据生成',         //./ == @/
        component: () => import('@/views/statics/create'),
        meta: { title: '数据生成', icon: 'table' }
      },
      {
        path: 'show',
        name: '数据展示',
        component: () => import('@/views/statics/show'),
        meta: { title: '数据展示', icon: 'tree' }
      },
    ]
  },
